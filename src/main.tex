...
\section{Стандарты для протоколов обмена ключами}\label{sec:IETF}
...
В сравнении со стандартным возведением в степень Монтгомери, который, напомним, используется в широко применяемых
...
Но сравнение этих графиков позволяет проследить интересную зависимость: время на получение секретного ключа (что
...
Были проанализированы как теоретические работы и практические имплементации, так и законы и стандарты, регулирующие
применение криптографии в целом и алгоритма Диффи-Хеллмана - в частности.
...
Также достойна изучения возможность реализации подобных модификаций для представлений Монтгомери эллиптических кривых.
